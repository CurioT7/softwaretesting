...
describe('Notification', () => {
    ...
    //     cy.wait(2000)
    //     cy.get(':nth-child(28) > [style="display: flex; gap: 0.5em;"] > .notification-details > .notifications-item-message > .notifications-item-message-text').should('contain', 'Blue_Whisper_2221 started following you.')
    //     cy.wait(2000)
    ...
    //     notification.seeallButton
    //     cy.wait(2000)
    //     cy.get(':nth-child(29) > [style="display: flex; gap: 0.5em;"] > .notification-details > .notifications-item-message > .notifications-item-message-text').should('contain', 'Your post has been upvoted by Blue_Whisper_2221.')
    //     cy.wait(2000)
    ...
    //         notification.seeallButton
    //         cy.wait(2000)
    //         cy.get(':nth-child(14) > [style="display: flex; gap: 0.5em;"] > .notification-details > .notifications-item-message').should('contain', 'samamostafa commented on your post "sprint2".')
    //         cy.wait(2000)
