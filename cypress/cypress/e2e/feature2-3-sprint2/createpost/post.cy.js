...
describe('create post', () => {
  ...
  //    cy.wait(2000)
   ...
   // })
    // it(' Input text post created  ', () => { error from front code
    //     const post  = new Post();
    //    post.createButton
    //    cy.wait(2000)
    // post.title.should('be.visible').type('sprint2720{enter}')
    ...
    //  cy.get('.dropdown-username').should('contain.text', 'u/maramtarek2');
