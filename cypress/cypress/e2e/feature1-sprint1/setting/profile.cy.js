  ...
  beforeEach(() => {
   ...
   // cy.visit('http://localhost:5173/settings/account')
    ...
    it('profile Display Name, about', () => {
      ...
      cy.wait(1000)
      accountSettingsPage.displayNamefield.type('qwertyuioasdfghasdfghjnbvadsfgdrhhhhhhhhhh{enter}')
    ...
    // Check if the input value (display name) is "Mero"
    cy.get('#display-name-input').invoke('val').should('eq', 'Mero');
    })
    ...
    it('profile about', () => {
      ...
      accountSettingsPage.about.clear().type('cairo university faculty of engineer ')
        cy.wait(2000); // Wait for 2 seconds (adjust as needed) for the profile to update
      cy.reload();
