...
describe('add comment', () => {
    ...
    it('add comment on post inside community', () => {
        ...
        cy.wait(2000)
        cy.get(':nth-child(13) > .chakra-card > .chakra-card__body > .chakra-heading').click()
        cy.wait(2000)
        add.comment.type('what')
        cy.wait(2000)
        add.add
        cy.wait(2000)
        cy.get(':nth-child(5) > :nth-child(2) > .post-details-content').should('be.exist')
    ...
    //     add.add
    //     cy.wait(2000)
    //     cy.get(':nth-child(5) > :nth-child(1) > .post-details-content').should('be.exist')
