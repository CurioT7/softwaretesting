export class AccountSettingsPage{
    ///////////// Account Settings /////////////////////////
    get setButton(){ return cy.get(':nth-child(5) > a > .profileImg').click()}
    get settButton(){return cy.get('a.sub-menu-link > .drop-down-description').click()}
    get accountSet(){return cy.get('#account-link').click()}
    ...
    get uploadAvatarImageButton(){return cy.get('[data-testid="profile-image"] > label > .upload-icon-profile').click()}
